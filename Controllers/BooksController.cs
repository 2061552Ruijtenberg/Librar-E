    ...
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Books != null ? 
                          ...
                          Problem("Entity set 'LibraryWebAppContext.Books'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Author,Description,Price,Worth,Category")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Author,Description,Price,Worth,Category")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
